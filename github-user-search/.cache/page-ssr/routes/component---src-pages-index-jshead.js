...
const IndexPage = () => {
  ...
  const toggleMode = () => {
    /* eslint-disable */console.log(...oo_oo(`cefa3af4_0`, 'clicked'));
  ...
  const handleKeyDown = async event => {
    if (event.key === "Enter") {
      ...
      try {
        ...
        /* eslint-disable */console.log(...oo_oo(`cefa3af4_1`, error));
        return;
      }
    }
  };
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      /* eslint-disable */console.log(...oo_oo(`cefa3af4_2`, error));
      return;
    }
  };
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("main", {
    className: `main ${isDarkMode ? "bg-dark-modebg" : ""}`

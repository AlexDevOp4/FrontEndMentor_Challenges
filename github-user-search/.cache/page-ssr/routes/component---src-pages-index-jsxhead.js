...
const IndexPage = () => {
  ...
  /* eslint-disable */
  console.log(...oo_oo(`3e04449d_0`, apiKey, apiUrl));

  /* eslint-disable */
  console.log(...oo_oo(`3e04449d_1`, "github_token_here"));
  const githubToken = "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";
  ...
  const handleChanges = e => {
    e.preventDefault();
    /* eslint-disable */
    console.log(...oo_oo(`3e04449d_2`, e.target.value));
  ...
  }, "test", "github_token_here", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {

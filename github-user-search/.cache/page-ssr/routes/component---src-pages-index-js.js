...
const IndexPage = () => {
  ...
  /* eslint-disable */
  console.log(...oo_oo(`a8e9778e_0`, apiKey, apiUrl));

  /* eslint-disable */
  console.log(...oo_oo(`a8e9778e_1`, "github_token_here"));
  ...
  const handleChanges = e => {
    e.preventDefault();
    /* eslint-disable */
    console.log(...oo_oo(`a8e9778e_2`, e.target.value));
